...
<div class="w3-container w3-padding-32 w3-center" id="about">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-12"><font size="5">September</font></h3>
    <p><font size="4">Event 1</font>
    </p>
    <p><font size="4">Event 2</font>
    </p>
    
    
    <p><font size="4">Event 3</font>
    </p>
  </div>
