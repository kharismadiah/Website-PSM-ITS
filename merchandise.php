...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
  ...
  <div class="w3-display-middle w3-margin-top w3-center">
    <h1 class="w3-xxlarge w3-animate-zoom"><span class="w3-border w3-border-black w3-padding">PSM</span> <span class="w3-hide-small">Merchandise</span></h1>
  </div>
  <style>
...
<!-- Merchandise Section -->
  <div class="w3-container w3-padding-32 w3-center" id="merchandise">
    <h3 class="w3-border-bottom w3-border-light-grey">Choose the best one.</h3>
    <p></p>
  </div>
  ...
  <div class="w3-row-padding w3-grayscale">
    <div class="w3-col l3 m6 w3-margin-bottom">
      ...
      <p><button class="w3-btn-block">Detail</button></p>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
